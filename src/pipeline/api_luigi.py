...
from src.pipeline.predict_luigi import TaskPredictMetadata

logging.basicConfig(level=logging.INFO)


class TaskAPI(CopyToTable):
    ...
    def requires(self):
        return [TaskPredictMetadata(self.ingesta, self.fecha, self.fecha_modelo, self.threshold, self.algoritmo,
